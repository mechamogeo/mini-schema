import type { ErrorMapFn, Issue } from 'mini-schema';

/**
 * Brazilian Portuguese (pt-BR) error messages for mini-schema
 */
export const ptBRErrorMap: ErrorMapFn = (issue: Issue): string => {
  switch (issue.code) {
    case 'invalid_type':
...
/**
 * Alias for ptBRErrorMap
 */
export const portugueseErrorMap = ptBRErrorMap;
